...
def _get(name: str):
    if name not in _modules:
        mapping = {
            ...
            "gas_calculator":   ("gas_calculator",    "Gas cost engine"),
    ...
    if scanner and hasattr(scanner, "scan"):
        ...
        for tri in triangles:
            ...
            try:
                ...
                # 2. Estimate gas
                gas_cost = None
                if gas_mod and hasattr(gas_mod, "estimate_gas"):
                    gas_cost = gas_mod.estimate_gas(tri)
                ...
                # 4. MEV competition check
                viable = True
                if competition_mod and hasattr(competition_mod, "is_viable"):

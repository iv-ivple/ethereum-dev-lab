...
def main():
    ...
    # Check for test mode
    if args.address.lower() == 'test':
        print("🧪 Running in TEST MODE with known active address...")
        print("Using Binance Hot Wallet: 0x28C6c06298d514Db089934071355E5743bf21d60")
        print("This address is guaranteed to have USDC transfers\n")
        args.address = '0x28C6c06298d514Db089934071355E5743bf21d60'
        if not args.token and not args.tokens:
            args.token = 'USDC'
        if not args.last_blocks and not args.from_block:
            args.last_blocks = 500  # Small range for testing
